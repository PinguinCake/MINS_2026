...
from strategies.search_strategy import ExactMedicineSearchStrategy, PartialMedicineSearchStrategy


class PharmacyService:
    def __init__(self, repository=None, event_manager=None):
    ...
    def find_medicine(self, name, exact=True):
        strategy = ExactMedicineSearchStrategy() if exact else PartialMedicineSearchStrategy()
