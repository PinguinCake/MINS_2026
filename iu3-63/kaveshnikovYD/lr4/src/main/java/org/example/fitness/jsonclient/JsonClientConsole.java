...
public class JsonClientConsole {
    private final IntJsonCLientOut jsonClientDumpHack;

    public JsonClientConsole(IntJsonCLientOut jsonClientDumpHack) {
    ...
    public String readAndBuildJson(Scanner scanner) {
        ...
        String rawJson = switch (option) {
            case "1" -> jsonClientDumpHack.allClientsJson();
            case "2" -> jsonClientDumpHack.activeClientsJson();
            case "3" -> jsonClientDumpHack.inactiveClientsJson();
            case "4" -> jsonClientDumpHack.visitBasedClientsJson();
            case "5" -> jsonClientDumpHack.timeBasedClientsJson();
