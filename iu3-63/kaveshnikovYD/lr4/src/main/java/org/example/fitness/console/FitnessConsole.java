...
import org.example.fitness.reference.TraceContext;
...
/**
 * Консольный интерфейс управления информационной системой фитнес-клуба.
 */
public class FitnessConsole {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                TraceContext.runWithNewTrace("команда-меню-" + choice, () -> handleCommand(choice));
    ...
    private void addTraining() {
        ...
        String minutesRaw = readLine("Длительность (минут), целое число: ").trim();
        String maxRaw = readLine("Макс. участников: ").trim();
        Training t = trainingService.createFromConsoleForm(name, desc, minutesRaw, maxRaw);
